# -*- coding: utf-8 -*-
"""TP_Multivariado.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Nqfc49gmw-Jxe98nXN8zcDt-9Db7Jv0N
"""
...
class LinearRegression():
    ...
    def __init__(
        ...
        :param max_iter: Máximo número de iteraciones (solo GD).
        :type max_iter: int
    ...
    def gradient_descent(
        ...
        return theta, max_iter, cost_history
...
"""# Pruebas con un dataset normalizado"""
...
"""## Parámetros obtenidos con sklearn"""

import sklearn.linear_model
modelo_sklearn = sklearn.linear_model.LinearRegression()
modelo_sklearn.fit(X, y)
modelo_sklearn.intercept_, modelo_sklearn.coef_

"""## Parámetros obtenidos con nuestro desarrollo"""
...
"""### Descenso por gradiente con el dataset completo"""
...
"""### Descenso por gradiente por minilotes"""
...
model_batch = LinearRegression(method="gd", mode="batch", learning_rate=0.05, max_iter=20000)
model_sgd   = LinearRegression(method="gd", mode="sgd", learning_rate=0.001, max_iter=20000)
model_mbgd  = LinearRegression(method="gd", mode="mbgd", batch_size=32, learning_rate=0.01, max_iter=20000)

model_batch.fit(X, y)
model_sgd.fit(X, y)
model_mbgd.fit(X, y)

"""### Gráfico de costo de aproximación por descenso de gradiente con el dataset completo respecto de las iteraciones realizadas"""

plt.plot(model_batch.cost_history)
plt.title("Costo vs Iteraciones (Batch GD)")
plt.xlabel("Iteración")
plt.ylabel("Costo")
plt.show()

"""### Gráfico de costo de aproximación por descenso de gradiente estocástico respecto de las iteraciones realizadas"""

plt.plot(model_sgd.cost_history)
plt.title("Costo vs Iteraciones (SGD)")
plt.xlabel("Iteración")
plt.ylabel("Costo")
plt.show()

"""### Gráfico de costo de aproximación por descenso de gradiente por minilotes respecto de las iteraciones realizadas"""

plt.plot(model_mbgd.cost_history)
plt.title("Costo vs Iteraciones (Batch MBGD)")
plt.xlabel("Iteración")
plt.ylabel("Costo")
plt.show()

"""### Gráfico comparativo de los tres modos de descenso por gradiente"""

plt.figure()

plt.plot(model_batch.cost_history, label="Batch GD")
plt.plot(model_sgd.cost_history, label="SGD")
plt.plot(model_mbgd.cost_history, label="Mini-Batch GD")
...
"""# Pruebas con un dataset no normalizado"""
...
"""## Parámetros obtenidos con nuestro desarrollo
### Regresión lineal analítica sin normalizar
"""
...
"""### Regresión lineal analítica con normalización"""
...
"""### Regresión lineal por descenso por gradiente utilizando todo el dataset"""
...
"""### Regresión lineal por descenso por gradiente estocástico"""
...
"""### Regresión lineal por descenso por gradiente utilizando minilotes del dataset"""
...
model_batch = LinearRegression(method="gd", mode="batch", normalize=True, learning_rate=0.01, max_iter=20000)
model_sgd   = LinearRegression(method="gd", mode="sgd", normalize=True, learning_rate=0.001, max_iter=20000)
model_mbgd  = LinearRegression(method="gd", mode="mbgd", normalize=True, batch_size=64, learning_rate=0.01, max_iter=20000)
...
"""### Gráfico de costo de aproximación por descenso de gradiente con minilotes del dataset respecto de las iteraciones realizadas"""
